...
const get = async (req, res, next) => {
    ...
    if (synthesizeQuery.method === 'stream') {
        try {
            const audioStream = await CapCutService_1.default.synthesizeStream(synthesizeQuery);
    ...
    try {
        const audioResult = await CapCutService_1.default.synthesizeBuffer(synthesizeQuery);
